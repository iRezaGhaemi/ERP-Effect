...
const MODS=[
 ...
 {id:'messenger',t:'پیام‌رسان',acts:['v','c']},
...
const ROLE_PERMS={
 r1:'*',
 r2:'*',
 r3:{dashboard:1,mytasks:1,tasks:1,workspaces:1,cpro:1,calendar:1,crm:1,customers:1,reports:1,social:1,team:1,messenger:1,leaves:1,invoices:1},
 r4:{dashboard:1,mytasks:1,tasks:1,workspaces:1,cpro:1,calendar:1,crm:1,customers:1,reports:1,social:1,messenger:1,leaves:1},
 r5:{dashboard:1,mytasks:1,tasks:1,calendar:1,messenger:1,leaves:1},
 r6:{dashboard:1,mytasks:1,crm:1,customers:1,reports:1,messenger:1,calendar:1},
 r7:{dashboard:1,mytasks:1,finance:1,invoices:1,reports:1,messenger:1,leaves:1,team:1},
 r8:{dashboard:1,mytasks:1,tasks:1,cpro:1,calendar:1,social:1,messenger:1,leaves:1},
 r9:{dashboard:1,mytasks:1,tasks:1,cpro:1,calendar:1,social:1,messenger:1,leaves:1},
};
/* Override فردی — فقط تفاوت با نقش ذخیره می‌شود (src=اختصاصی) */
let USER_OVERRIDES={
 e5:{reports:{v:1},customers:{v:1}},          /* علی: گزارش‌ها و مشتریان — اختصاصی */
 e9:{messenger:{v:1}},                        /* زهرا: پیام‌رسان — اختصاصی */
...
const modOfRoute=r=>({dashboard:'dashboard',mytasks:'mytasks',tasks:'tasks',workspaces:'workspaces',calendar:'calendar',
 ...
 reports:'reports',social:'social',team:'team',messenger:'messenger',integrations:'integrations',settings:'settings',
